...
_DATA_SCHEMA_FILE_YAML = 'dataschema.file.schema.yaml'
_BLOCK_FILE_YAML = 'block.file.schema.yaml'
_RECIPE_FILE_YAML = 'recipe.file.schema.yaml'
...
class SchemaLoader:
    ...
    def _load_schema(cls, filename: str) -> Dict[str, Any]:
        if __package__ is None:
            raise PrismError("Package is not defined")
        try:
    ...
    def get_dataschema_schema(cls) -> Dict[str, Any]:
        return cls._load_schema(_DATA_SCHEMA_FILE_YAML)

    @classmethod
    def get_block_schema(cls) -> Dict[str, Any]:
        return cls._load_schema(_BLOCK_FILE_YAML)

    @classmethod
    def get_recipe_schema(cls) -> Dict[str, Any]:
        return cls._load_schema(_RECIPE_FILE_YAML)